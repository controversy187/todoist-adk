...
def test_basic_functionality():
    ...
    if tasks:
        ...
        comment_result = add_task_comment(
            task_id, "Test comment from smart prioritization system"
        )
...
def test_agent_import():
    ...
    try:
        ...
        print(f"  Agent name: {smart_prioritization.name}")
        print(f"  Available tools: {len(smart_prioritization.tools)}")
